...
class SceneGraphModel(QtCore.QAbstractItemModel):
    ...
    def parent(self, index):
        print("parent index:{}".format(repr(index)))   
        node = self.getNode(index)
        
        parentNode = node.parent()
        print("\tparentNode is {}".format(parentNode))
        
        if parentNode == self._rootNode:
            print("\tReturn invalid")
            return QtCore.QModelIndex()
        print("\tcreate a {} 0 {}".format(parentNode.row(), 0, parentNode)) 
    ...
    def index(self, row, column, parent):
        print("index row {} column {} parent {}".format(row, column, parent)) 
        ...
        if childItem:
            print("\tcreate a {} {} childitem {}".format(row, column, childItem))
