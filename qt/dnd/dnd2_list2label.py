...
# http://rowinggolfer.blogspot.tw/2010/04/pyqt4-modelview-drag-drop-example.html
...
class simple_model(QtCore.QAbstractListModel):
    def __init__(self, parent=None):
        ...
        self.setSupportedDragActions(QtCore.Qt.MoveAction | QtCore.Qt.CopyAction)
...
class draggableList(QtGui.QListView):
    ...
    def dragEnterEvent(self, event):
        if event.mimeData().hasFormat("application/x-person"):
            print "draggableList dragEnterEvent"
