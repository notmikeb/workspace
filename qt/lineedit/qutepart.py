...
[docs]class Qutepart(QPlainTextEdit):
...
[docs]    def replaceText(self, pos, length, text):
...
[docs]    def insertText(self, pos, text):
...
[docs]    def isComment(self, line, column):
...
[docs]    def isBlockComment(self, line, column):
...
[docs]    def isHereDoc(self, line, column):
...
[docs]    def setExtraSelections(self, selections):
...
[docs]    def mapToAbsPosition(self, line, column):
...
[docs]    def mapToLineCol(self, absPosition):
...
[docs]def iterateBlocksFrom(block):
...
[docs]def iterateBlocksBackFrom(block):
